// #include "pch.h", well this isn't a console project
#include <iostream>
#include <string>
...
int main()
{
	...
	// int foo = 0; <-- This int variable is never used
	int vowels = 0;
	int consonants = 0;
	int digits = 0;
	int spaces = 0;
	...
	int checkSum = 0;
	// int bar = 0; <-- this int variable is never used
	...
	for (int i = 0; i < textToAnalyze.length(); ++i)
	{
		...
		{
			++consonants; // Uncommented this line of code
		}
